        ...
        {trades.map((trade) => {
          ...
          return (
            <div
              ...
              className="relative bg-[#0d131f] border border-slate-800/80 hover:border-slate-700 rounded-xl p-4 cursor-pointer transition-all duration-200 hover:scale-[1.01] hover:shadow-xl group"
            >
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                  <span className="text-xs font-mono font-bold text-cyan-400 bg-cyan-500/5 border border-cyan-500/10 px-2 py-1 rounded">
                    {openTime}
                  </span>
                ...
                {/* Direita: Pontos, Financeiro e CTA */}
